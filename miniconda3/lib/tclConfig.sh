...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /root/miniconda3/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1699201809505/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/root/miniconda3=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /root/miniconda3/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/root/miniconda3/lib -Wl,-rpath-link,/root/miniconda3/lib -L/root/miniconda3/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/root/miniconda3/lib -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/root/miniconda3/include'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/root/miniconda3/lib -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/root/miniconda3/lib/libtclstub8.6.a'
