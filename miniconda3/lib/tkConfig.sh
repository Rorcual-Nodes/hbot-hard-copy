...
# build directory.
TK_BUILD_LIB_SPEC='-L/root/miniconda3/lib -ltk8.6'
...
# compiled.
TK_SRC_DIR='/root/miniconda3/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/root/miniconda3/lib -ltkstub8.6'
...
TK_BUILD_STUB_LIB_PATH='/root/miniconda3/lib/libtkstub8.6.a'
