...
# installed.
TCL_PREFIX='/root/miniconda3/envs/hummingbot'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/root/miniconda3/envs/hummingbot'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /root/miniconda3/envs/hummingbot/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1699201809505/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/root/miniconda3/envs/hummingbot=/usr/local/src/conda-prefix -pipe -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /root/miniconda3/envs/hummingbot/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/root/miniconda3/envs/hummingbot/lib -Wl,-rpath-link,/root/miniconda3/envs/hummingbot/lib -L/root/miniconda3/envs/hummingbot/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/root/miniconda3/envs/hummingbot/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/root/miniconda3/envs/hummingbot/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/root/miniconda3/envs/hummingbot/include'
...
# compiled.
TCL_SRC_DIR='/root/miniconda3/envs/hummingbot/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/root/miniconda3/envs/hummingbot/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/root/miniconda3/envs/hummingbot/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/root/miniconda3/envs/hummingbot/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/root/miniconda3/envs/hummingbot/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/root/miniconda3/envs/hummingbot/lib/libtclstub8.6.a'
